(function($app) {
  angular.module('report.services', []).service('ReportService', function($http, $compile, $modal, $translate, $window, $rootScope, $ionicModal) {
    var body = $('body');
    ...
    this.openURLContent = function(url) {
      ...
      //   body.append('<div id="reportViewContext" ng-include="\'node_modules/cronapp-framework-mobile-js/components/reports/reports.view.html\'"></div>');
      //   $compile(body)(scope);
    ...
    this.showParameters = function(report) {
      ...
      var next = function() {
        if(index < parameters.length) {
          ...
          // $modal.open({
          //   templateUrl : 'node_modules/cronapp-framework-mobile-js/components/reports/reports.parameters.html',
          ...
          scope.report = report;//JSON.parse(JSON.stringify(report));
          scope.htmlParameters = htmlParameters;//JSON.parse(JSON.stringify(htmlParameters));
          ...
          //   return $scope.isToShow;
          // };

          // scope.showParamsModal =function(show) {
          //   $modalInstance.close();
          ...
          // $rootScope.htmlParameters = htmlParameters;
          ...
          scope.onPrint = function() {
            if (scope.report.reportName.endsWith('.report')) {
              _this.openStimulsoftReport(scope.report.contentData, scope.report.parameters, scope.report.datasourcesInBand);
            }
            scope.onCancel();
            // else {
              // ReportService.getPDFAsFile($scope.report).then(openPDFAsFile);
            // }
            // $scope.showParamsModal(false);
          };

          scope.onCancel = function() {
            // var modal = $('#parameterModal').data('cronapp-modal');
            scope.ionicModal.remove();
          };


          // if($('#parameterModal').data('cronapp-modal') ) $('#parameterModal').data('cronapp-modal').remove();
          $ionicModal.fromTemplateUrl('node_modules/cronapp-framework-mobile-js/components/reports/reports.parameters.html', {
            // scope: $rootScope,
            scope: scope,
            animation: 'slide-in-up'//,
          }).then(function(modal){
            // $('#parameterModal').data('cronapp-modal', modal);
            // modal.scope.report = JSON.parse(JSON.stringify(report));
            // modal.scope.htmlParameters = JSON.parse(JSON.stringify(htmlParameters));
